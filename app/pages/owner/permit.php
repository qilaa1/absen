...
<head>
    ...
    <title>Absensi Karyawan - Cuti & Perizinan</title>
    <!-- Favicon-->
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid p-4">
                ...
                <div
                    class="flex flex-col md:flex-row items-center justify-between mb-4 space-y-2 md:space-y-0 md:space-x-2">
                    <div class="flex space-x-2">
                        <button class="bg-blue-600 text-white px-4 py-2 rounded" id="historyToggle"
                            data-bs-toggle="modal" data-bs-target="#approvalModal">Riwayat Persetujuan</button>
                    </div>
                    <input type="text" id="searchInput" class="border border-gray-300 rounded px-2 py-1 w-full md:w-64"
                        placeholder="Cari Nama Staff">
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8" id="status-container">
                    <div
                        class="bg-white shadow-50 p-6 rounded-lg shadow min-w-[300px] h-[200px] flex flex-col justify-center items-center">
                        <h3 class="text-yellow-500 text-center text-lg font-sans font-bold mt-5">SEDANG DALAM PERMOHONAN
                        </h3>
                        <p id="pending-count"
                            class="text-3xl font-extrabold text-yellow-500 text-center font-mono mt-4">0</p>
                    ...
                    <div
                        ...
                        <p id="answered-count"
                            class="text-3xl font-extrabold text-green-500 text-center font-mono mt-4">0</p>
                    ...
                    <div id="izinTable" class="table-container">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th
                                        class="px-4 py-3 text-center text-xs font-medium text-gray-600 uppercase tracking-wider border-r border-gray-200">
                                        Nama Staff</th>
                                    <th
                                        class="px-4 py-3 text-center text-xs font-medium text-gray-600 uppercase tracking-wider border-r border-gray-200">
                                        Tanggal</th>
                                ...
                                foreach ($dataIzin as $row): ?>
                                    <tr>
                                        <td class="text-center px-4 py-3">
                                            <?php echo htmlspecialchars($row['Nama_Staff']); ?></td>
                                        <td class="text-center px-4 py-3"><?php echo htmlspecialchars($row['tanggal']); ?>
                                        </td>
                                        <td class="text-center px-4 py-3">
                                            <?php echo htmlspecialchars($row['jenis_izin']); ?></td>
                                        <td class="text-center px-4 py-3">
                                            <?php echo htmlspecialchars($row['keterangan']); ?></td>
                                        </td>
                    ...
                    <div id="cutiTable" class="table-container hidden">
                        ...
                        WHERE c.status = 'pending'";
                                ...
                                foreach ($dataCuti as $row):
                                    ...
                                    <tr>
                                        <td class="text-center px-4 py-3">
                                            <?php echo htmlspecialchars($row['nama_lengkap']); ?></td>
                                        <td class="text-center px-4 py-3">
                                            <?php echo date('d M Y', strtotime($row['tanggal_mulai'])); ?></td>
                                        <td class="text-center px-4 py-3">
                                            <?php echo date('d M Y', strtotime($row['tanggal_selesai'])); ?></td>
                                        <td class="text-center px-4 py-3">
                                            <?php echo htmlspecialchars($row['durasi_cuti'] . ' hari'); ?></td>
                                        <td class="text-center px-4 py-3">
                                            <?php echo htmlspecialchars($row['keterangan']); ?></td>
                                        <td class="text-center">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <button class="btn btn-danger" onclick="confirmDelete()">Hapus Data</button>
                                    <!-- Tombol Hapus -->
                                </div>
                                ...
                                <div id="izinHistoryTable" class="table-container max-h-[300px] overflow-y-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        <thead class="bg-gray-50">
                                            <tr>
                                                <th
                                                    class="px-6 py-3 text-center text-xs font-medium text-gray-600 uppercase tracking-wider border-r border-gray-200">
                                                    Nama Staff</th>
                                                <th
                                                    class="px-6 py-3 text-center text-xs font-medium text-gray-600 uppercase tracking-wider border-r border-gray-200">
                                                    Tanggal</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center px-4 py-3">
                                                        <?php if ($row['status'] == 'disetujui'): ?>
                                                            <span
                                                                class="bg-green-500 text-white py-1 px-2 rounded">DISETUJUI</span>
                                                        <?php else: ?>
                                            ...
                                            foreach ($dataCuti as $row): ?>
                                                <tr>
                                                    <td class="px-4 py-3 text-center">
                                                        <?php echo htmlspecialchars($row['nama_staff']); ?></td>
                                                    <td class="px-4 py-3 text-center">
                                                        <?php echo htmlspecialchars($row['tanggal_mulai']); ?></td>
                                                    <td class="px-4 py-3 text-center">
                                                        <?php echo htmlspecialchars($row['tanggal_selesai']); ?></td>
                                                    <td class="px-4 py-3 text-center">
                                                        <?php echo htmlspecialchars($row['durasi_cuti']); ?></td>
                                                    <td class="px-4 py-3 text-center">
                                                        <?php echo htmlspecialchars($row['keterangan']); ?></td>
                                                    <td class="px-4 py-3 text-center">
                                                        <?php if ($row['status'] == 'disetujui'): ?>
