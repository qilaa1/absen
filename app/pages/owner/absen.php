...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (!checkEmployeeRole($pdo, $userId)) {
            throw new Exception('Akses ditolak. Hanya Owner yang dapat melakukan presensi.');
        }
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            ...
                            <div class="text-center position-relative mb-5">
                                ...
                                <p class="text-muted fs-5 mb-0">Gunakan kamera Anda untuk memindai QR Code dan mendapatkan kode presensi.</p>
                            </div>
                            ...
                            <div class="container mt-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-6 text-center">
                                        ...
                                        <!-- Upload file QR -->
                                        <label for="file-upload" class="form-label">Atau pilih gambar QR dari galeri:</label>
                                        <input type="file" id="file-upload" accept="image/*" class="form-control mb-4" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <form id="attendanceForm" method="POST">
                                        <div class="input-wrapper mb-4">
                                            ...
                                            <div class="modern-input-group">
                                                <input type="text" class="modern-input" id="unique_code" name="unique_code" placeholder="Masukkan 6 digit kode" required maxlength="6" pattern="^[a-zA-Z0-9]{6}$" />
    ...
    <script>
        ...
        if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
            ...
            scanner.addListener('scan', function(content) {
                document.getElementById('unique_code').value = content;
        ...
        document.getElementById("file-upload").addEventListener("change", async (e) => {
            ...
            try {
                ...
                console.log("QR dari gambar:", decodedText);
                document.getElementById("unique_code").value = decodedText;
                html5QrCode.clear();
            } catch (err) {
                console.warn("QR gagal dibaca:", err);
