...
<script>
    ...
    function exportData(type) {
        const timestamp = new Date().toISOString().split('T')[0]; // Mendapatkan timestamp dalam format YYYY-MM-DD
        const filename = `rekap_presensi_${timestamp}.${type}`; // Gunakan backticks untuk template literal
        // Simulasi download
        alert(`Downloading ${filename}...\nNote: This is just a UI demonstration.`); // Gunakan backticks di sini juga
    }
