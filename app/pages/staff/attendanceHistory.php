                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <?php else: ?>
                                <?php foreach ($attendances as $attendance): ?>
                                    <tr>
                                        <td
                                            class="px-6 py-4 text-center text-xm font-medium text-gray-500 uppercase tracking-wider">
                                            <?= htmlspecialchars(date('d-m-Y', strtotime($attendance['tanggal']))) ?>
                                        </td>
                                        <td
                                            class="px-6 py-4 text-center text-xm font-medium text-gray-500 uppercase tracking-wider">
                                            <?= htmlspecialchars($attendance['jadwal_shift']) ?>
                                        </td>
                                        <td
                                            class="px-6 py-4 text-center text-xm font-medium text-gray-500 uppercase tracking-wider">
                                            <?= $attendance['waktu_masuk'] ? htmlspecialchars(date('H:i', strtotime($attendance['waktu_masuk']))) : '-' ?>
                                        </td>
                                        <td
                                            class="px-6 py-4 text-center text-xm font-medium text-gray-500 uppercase tracking-wider">
                                            <?= $attendance['waktu_keluar'] ? htmlspecialchars(date('H:i', strtotime($attendance['waktu_keluar']))) : '-' ?>
                                        </td>
                                        <td
                                            class="px-6 py-4 text-center text-xm font-medium text-gray-500 uppercase tracking-wider">
                                            <span
                                                class="badge rounded-pill <?= getBadgeClass($attendance['status_kehadiran']) ?>">
